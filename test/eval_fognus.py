...
from datasets import FogNus, Collate
...
if __name__ == "__main__":
    ...
    with open("./datasets/fog-nus.yaml") as stream:
    ...
    for it, batch in enumerate(
        ...
        if id_vote == args.num_votes:
            ...
            true_label_path = absolute_path.replace("code/WaffleIron/AMW-NET/result/semantic_fognus/predictions_fognus_32_9", "sda/Dataset/Weather_Nuscenes/Fog-Nuscenes").replace("predictions", "fog_label")
