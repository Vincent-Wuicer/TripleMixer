...
pred_dir = "/home/hit/code/WaffleIron/AMW-NET/result/semantic_snowkitti/predictions_snowkitti_32_9"

true_dir = "/home/hit/sda/Dataset/Weather_KITTI/Snow-KITTI"
...
for root, dirs, files in os.walk(pred_dir):
    for file in files:
        if file.endswith(".label"):
            ...
            true_label_path = pred_label_path.replace("code/WaffleIron/AMW-NET/result/semantic_snowkitti/predictions_snowkitti_32_9", "sda/Dataset/Weather_KITTI/Snow-KITTI").replace("predictions", "snow_label")
