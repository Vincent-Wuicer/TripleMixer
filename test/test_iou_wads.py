...
pred_dir = "/home/hit/sda/Second_paper_revise/Triplemixer/result/predictions_wads_v25_w24"
true_dir = "/home/hit/sda/WADS2/sequences"
...
for root, dirs, files in os.walk(pred_dir):
    for file in files:
        if file.endswith(".label"):
            ...
            true_label_path = pred_label_path.replace("Second_paper_revise/Triplemixer/result/predictions_wads_v25_w24", "WADS2/sequences").replace("predictions", "snow_labels")
