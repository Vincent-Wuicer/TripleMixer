...
def P_R_fog_soft(p: ParameterSet, pc: np.ndarray, original_intesity: np.ndarray, noise: int, gain: bool = False,
    ...
    return augmented_pc, simulated_fog_pc, num_fog, info_dict, fog_label
...
def simulate_fog(p: ParameterSet, pc: np.ndarray, noise: int, gain: bool = False, noise_variant: str = 'v1',
    ...
    if soft:
        augmented_pc, simulated_fog_pc, num_fog, info_dict, fog_label = P_R_fog_soft(p, augmented_pc, original_intensity, noise, gain,
                                                                 noise_variant)
...
if __name__ == '__main__':
    ...
    for seq in [str(i).zfill(2) for i in range(22)]:
        ...
        def _map(i: int) -> None:
            ...
            points, fog_points, num_fog, _ , fog_label= simulate_fog(parameter_set, points, 10)
