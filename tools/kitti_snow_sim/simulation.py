...
if __name__ == '__main__':
    ...
    for seq in [str(i).zfill(2) for i in range(22)]:
        #if seq in ['05','06','07','16','21','09','11','12','13','14','15','16']:
        if seq not in ['00']:
            continue
        all_files = []
        seq_folder = os.path.join(args.root_folder, seq)
        # val_txt = os.path.join(src_folder, '.txt')
        val_txt = seq_folder + '.txt'
        src_folder = seq_folder + '/velodyne/'
        info_txt = seq_folder + '/info.txt'
        #print(val_txt)
        ...
        with ProcessPoolExecutor(max_workers=100) as executor:
            futures = {executor.submit(process_file, file, args, dst_folder, snowflake_file_prefix, beam_divergence, seq) for file in all_files}
